    ...
    <section className="resin">
      ...
      <div className="resin_select">
        ...
        <ul className="resin_select-option">
          <li onClick={()=>{setResin("bajo espesor")}} tabindex="0">
            Resina de Bajos Espesores 100:50 (Cubiertas de cocina, pisos,
            charolas, etc.)
          </li>
          <li onClick={()=>{setResin("alto espesor")}} tabindex="0">
      ...
      <div className="resin_content-btn">
        ...
        <button onClick={()=>{handleOption()}} className="resin_form-button">Siguiente</button>
      </div>
    </section>
  );
};
